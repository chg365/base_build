...
PCRE_VERSION="8.42"
#PCRE2_VERSION="10.31" # pcre2 编译apache时报错
...
GLIB_VERSION="2.54.3" # 2.52.3没编译过去,报错 libblkid.so: undefined reference to `uuid_unparse@UUID_1.0'
...
LARAVEL_FRAMEWORK_VERSION="5.7.6"
...
NGINX_HTTP_GEOIP2_MODULE_VERSION="3.0"
