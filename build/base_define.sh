...
RE2C_VERSION="1.0.1" # http://re2c.org/about/about.html#version
...
NODEJS_VERSION="6.11.2" #8.4.0 gitbook-pdf安装时， phantomjs安装不上，参数不启作用了
CALIBRE_VERSION="3.7.0"
...
SWOOLE_VERSION="2.0.8" # http://pecl.php.net/package/swoole
...
LARAVEL_FRAMEWORK_VERSION="5.4.33"

CKEDITOR_VERSION="4.7.2" #  www.ckeditor.com
...
WEB_SERVICE_COMMON_PHP_VERSION="0.4.0"
GEOIP2_PHP_VERSION="2.6.0"
...
PROTOBUF_FILE_NAME="protobuf-${PROTOBUF_VERSION}.tgz"
GRPC_FILE_NAME="grpc-${GRPC_VERSION}.tgz"
