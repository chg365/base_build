...
if [ "$OS_NAME" != 'darwin' ];then
    ...
    if [ "$gcc_new_version" = "$gcc_minimum_version" ]; then
        ...
        ICU_VERSION="64.1" #升级到 59.1后 PHP7.1.8的intl扩展编译不过去 60.2 php 7.2.0编译不过去
    fi
fi
...
LARAVEL_VERSION="5.8.3"
LARAVEL_FRAMEWORK_VERSION="5.8.13"

CKEDITOR_VERSION="4.11.4"
JQUERY_VERSION="1.12.4.min"
JQUERY3_VERSION="3.4.0.min"
D3_VERSION="5.9.2"
