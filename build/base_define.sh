...
RE2C_VERSION="1.0.3" # http://re2c.org/about/about.html#version
...
JSON_VERSION="0.13" # https://github.com/json-c/json-c/releases
LIBFASTJSON_VERSION="0.99.8" # https://github.com/rsyslog/libfastjson/releases
...
NODEJS_VERSION="9.3.0" #8.4.0 gitbook-pdf安装时， phantomjs安装不上，参数不启作用了
CALIBRE_VERSION="3.15.0"
GITBOOK_VERSION="3.2.2"
GITBOOK_CLI_VERSION="2.3.2"
RSYSLOG_VERSION="8.31.0"
...
ZIP_VERSION="1.15.2"
SWOOLE_VERSION="2.0.12" # http://pecl.php.net/package/swoole
PHP_PROTOBUF_VERSION="3.5.1"
PHP_GRPC_VERSION="1.8.3"
...
LARAVEL_FRAMEWORK_VERSION="5.5.28"
