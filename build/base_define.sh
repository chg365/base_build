...
PCRE_VERSION="8.43"
#PCRE2_VERSION="10.33" # pcre2 编译apache时报错
...
if [ "$OS_NAME" != 'darwin' ];then
    ...
    if [ "$gcc_new_version" = "$gcc_minimum_version" ]; then
        ...
        ICU_VERSION="64.2" #升级到 59.1后 PHP7.1.8的intl扩展编译不过去 60.2 php 7.2.0编译不过去
    fi
fi
...
SCWS_VERSION="1.2.3"
XAPIAN_CORE_SCWS_VERSION="1.4.9"
XUNSEARCH_VERSION="1.4.13"
XUNSEARCH_SDK_VERSION="1.4.13"
XUNSEARCH_FULL_VERSION="1.4.13"

XAPIAN_CORE_VERSION="1.4.11"
XAPIAN_OMEGA_VERSION="1.4.9" # 使用scws 的xapian
XAPIAN_BINDINGS_VERSION="1.4.9" # 使用scws 的xapian
...
CALIBRE_VERSION="3.44.0"
GITBOOK_VERSION="3.2.2"
GITBOOK_CLI_VERSION="2.3.2"
RSYSLOG_VERSION="8.1905.0"
...
PHP_VERSION="7.2.20" #7.3.7 有内存溢出风险，回退到7.2
COMPOSER_VERSION="1.8.6"
BROWSCAP_INI_VERSION="6000034"
PYTHON_VERSION="3.7.3"

if [ `echo "${PHP_VERSION}" "7.1.99"|tr " " "\n"|sort -rV|head -1` = "7.1.99" ]; then
    PHP_LIBSODIUM_VERSION="1.0.7"
else
    PHP_LIBSODIUM_VERSION="2.0.21"
fi
...
PECL_HTTP_VERSION="3.2.1"
AMQP_VERSION="1.9.4"
MAILPARSE_VERSION="3.0.3"
PHP_REDIS_VERSION="5.0.0"
PHP_GEARMAN_VERSION="2.0.5"
PHP_MONGODB_VERSION="1.5.5"
SOLR_VERSION="2.4.0"
IMAGICK_VERSION="3.4.4"
PTHREADS_VERSION="master"
ZIP_VERSION="1.15.4"
SWOOLE_VERSION="4.3.5"
PSR_VERSION="0.6.1"
PHP_PROTOBUF_VERSION="3.8.0"
PHP_GRPC_VERSION="1.22.0" # 1.20.0 编译后，段错误
...
LARAVEL_VERSION="5.8.17"
LARAVEL_FRAMEWORK_VERSION="5.8.27"
...
IMAGEMAGICK_FILE_NAME="ImageMagick-${IMAGEMAGICK_VERSION}.tar.gz"
...
CLAMAV_CONF_DIR="$BASE_DIR/etc/clamav"
