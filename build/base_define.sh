...
CURL_VERSION="7.63.0" # 7.60.0编译不过去
...
LIBGD_VERSION="2.2.5"
IMAGEMAGICK_VERSION="7.0.8-25"
JPEG_VERSION="9c"
LIBPNG_VERSION="1.6.36"
NASM_VERSION="2.14.02"
LIBJPEG_VERSION="2.0.1"
OPENJPEG_VERSION="2.3.0" # 2.1.0
CAIRO_VERSION="1.14.6"
PIXMAN_VERSION="0.36.0"
EXPAT_VERSION="2.2.6"
FREETYPE_VERSION="2.9.1"
GLIB_VERSION="2.56.4" # 2.52.3没编译过去,报错 libblkid.so: undefined reference to `uuid_unparse@UUID_1.0'
UTIL_LINUX_VERSION="2.33.1"
...
CALIBRE_VERSION="3.38.1"
GITBOOK_VERSION="3.2.2"
GITBOOK_CLI_VERSION="2.3.2"
RSYSLOG_VERSION="8.1901.0"
...
LARAVEL_VERSION="5.7.19"
LARAVEL_FRAMEWORK_VERSION="5.7.22"

CKEDITOR_VERSION="4.11.2"
