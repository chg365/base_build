...
NODEJS_VERSION="9.1.0" #8.4.0 gitbook-pdf安装时， phantomjs安装不上，参数不启作用了
CALIBRE_VERSION="3.12.0"
...
LARAVEL_FRAMEWORK_VERSION="5.5.20"
