...
CURL_VERSION="7.54.1"
ICU_VERSION="59.1" # 59.1 gcc要4.4.8以上 http://site.icu-project.org/
if [ "$OS_NAME" != 'darwin' ];then
...
IMAGEMAGICK_VERSION="7.0.6-0" # http://www.imagemagick.org/download/
...
LARAVEL_FRAMEWORK_VERSION="5.4.27"
