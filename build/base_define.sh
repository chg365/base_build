...
CURL_VERSION="7.61.0" # 7.60.0编译不过去
...
PHP_GRPC_VERSION="1.14.1"
#PHP_QRENCODE_VERSION="0.0.3"
PHP_QRENCODE_VERSION="0.1.0"

ZEND_VERSION="2.4.9"
SMARTY_VERSION="3.1.32"
HTMLPURIFIER_VERSION="4.10.0"
LARAVEL_VERSION="5.6.33"
LARAVEL_FRAMEWORK_VERSION="5.6.34"

CKEDITOR_VERSION="4.10.0"
...
GEOIPUPDATE_VERSION="3.1.0"
ELECTRON_VERSION="2.0.7"
if [ "$OS_NAME" = 'darwin' ];then
