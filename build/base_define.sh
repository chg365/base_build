...
CURL_VERSION="7.65.0" # 7.60.0编译不过去
...
CALIBRE_VERSION="3.42.0"
GITBOOK_VERSION="3.2.2"
GITBOOK_CLI_VERSION="2.3.2"
RSYSLOG_VERSION="8.1904.0"
...
PHP_VERSION="7.2.18" #7.3.5 有内存溢出风险，回退到7.2
...
PHP_PROTOBUF_VERSION="3.7.1"
PHP_GRPC_VERSION="1.19.0" # 1.20.0 编译后，段错误
...
LARAVEL_FRAMEWORK_VERSION="5.8.18"

CKEDITOR_VERSION="4.11.4"
