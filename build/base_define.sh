...
LIBXML2_VERSION="2.9.5" # ftp://xmlsoft.org/libxml2/
...
LIBGD_VERSION="2.2.5" # http://libgd.github.io/
IMAGEMAGICK_VERSION="7.0.7-3" # http://www.imagemagick.org/download/
...
GLIB_VERSION="2.52.2" # 2.52.3没编译过去,报错 libblkid.so: undefined reference to `uuid_unparse@UUID_1.0'
...
NODEJS_VERSION="6.11.3" #8.4.0 gitbook-pdf安装时， phantomjs安装不上，参数不启作用了
CALIBRE_VERSION="3.8.0"
...
LARAVEL_FRAMEWORK_VERSION="5.5.11"

CKEDITOR_VERSION="4.7.3"
JQUERY_VERSION="1.12.4.min"
JQUERY3_VERSION="3.2.1.min"
